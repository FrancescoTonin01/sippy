    ...
    >
      ...
      {drinks.length === 0 ? (
        <div className="text-center py-8">
          ...
          <p className="text-gray-500">Nessun drink ancora registrato</p>
        </div>
      ) : (
            ...
            return (
              <motion.div
                ...
                className={`flex items-center gap-3 p-3 rounded-lg transition-colors ${
                  isCurrentUser ? 'bg-teal-50 border border-teal-100' : 'bg-gray-50'
                }`}
              >
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold ${
                  isCurrentUser ? 'bg-teal-100 text-teal-600' : 'bg-gray-200 text-gray-600'
                }`}>
